...
\subsection*{无量纲变量}
    ...
    \begin{equation}
        ...
        \label{eq:4.79}
    \end{equation}
    其中，我们用到了$\mathrm{d}x_r/\mathrm{d}x = B^{-1/2}$。将(\ref{eq:4.68})、(\ref{eq:4.77})和(\ref{eq:4.79})代入薛定谔方程$-\left(\hbar^2/m\right)\left(\mathrm{d}^2\psi/\mathrm{d}x^2\right) $\\$+ V\psi = E\psi$，得到
    \begin{equation*}
